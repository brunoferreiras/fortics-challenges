...
# Sobre o desafio
Sua tarefa é construir um front-end para a aplicação WebChat. A aplicação é uma simples interface para a comunicação entre usuários (clientes) e agentes (atendentes) em tempo real.

O front-end deve ser construído utilizando a biblioteca React, [seguindo as especificações de layout do projeto](https://xd.adobe.com/view/09965a21-b721-4504-925d-95f21ef48d32-5cc5/).
...
# Requisitos
- Deve ser em React
- Necessário a utilização de alguma biblioteca CSS
- Sinta-se à vontade para usar qualquer framework de controle de estado desejado
- Boa qualidade de UI/UX
- Testes de front-end
- Responsividade
- Fidelização ao layout (Você também pode nos surpreender :D)
